...
<div class="row">
    <div class="col-md-2">
        <ul class="navbar-nav bg-secondary text-center text-light" style="height: 90vh;">
            <li class="nav-item bg-info">
                <a class="nav-link" href="profile.php"><h4>My Profile</h4></a>
            </li>
            <li class="nav-item">
